    ...
    ***************************************************************************** */
        ...
        Pagination.prototype.renderPages = function () {
            ...
            return (a(y, null,
                ...
                Array.from(Array(maxCount).keys())
                    ...
                    .map(function (i) {
                        return (a("button", {
                            tabIndex: 0, role: "button", onClick: _this.setPage.bind(_this, i), className: classJoin(_this.state.page === i
                                ? classJoin(className('currentPage'), _this.config.className.paginationButtonCurrent)
                                : null, _this.config.className.paginationButton), title: _this._('pagination.page', i + 1), "aria-label": _this._('pagination.page', i + 1)
                        }, _this._("" + (i + 1))));
                    }),
    ...
    var Config = /** @class */ (function () {
        ...
        Config.fromUserConfig = function (userConfig) {
            ...
            config.plugin.add({
                ...
                props: __assign({
                    enabled: userConfig.pagination === true ||
    ...
    var TD = /** @class */ (function (_super) {
        ...
        TD.prototype.content = function () {
            ...
            if (this.props.column && this.props.column.plugin) {
                return (a(PluginRenderer, {
                    pluginId: this.props.column.id, props: {
    ...
    var TH = /** @class */ (function (_super) {
        ...
        TH.prototype.content = function () {
            ...
            if (this.props.column.plugin !== undefined) {
                return (a(PluginRenderer, {
                    pluginId: this.props.column.plugin.id, props: {
                        column: this.props.column,
                    }
                }));
            }
    ...
    var Table = /** @class */ (function (_super) {
        ...
        Table.prototype.render = function () {
            return (a("table", {
                role: "grid", className: classJoin(className('table'), this.config.className.table), style: __assign(__assign({}, this.config.style.table), {
    ...
    var Container = /** @class */ (function (_super) {
        ...
        Container.prototype.render = function () {
            ...
            return (a(configContext.Provider, { value: this.props.config },
                a("div", {
                    role: "complementary", className: classJoin('gridjs', className('container'), this.state.status === Status.Loading ? className('loading') : null, this.props.config.className.container), style: __assign(__assign({}, this.props.config.style.container), {
                        width: this.props.width,
                    })
                },
